		    ...
		    const struct bpf_link_create_opts *opts)
{
	...
	case BPF_MODIFY_RETURN_MULTI:
		attr.link_create.tracing_multi.btf_type_ids = ptr_to_u64(OPTS_GET(opts, tracing_multi.btf_type_ids, 0));
		attr.link_create.tracing_multi.btf_fds = ptr_to_u64(OPTS_GET(opts, tracing_multi.btf_fds, 0));
